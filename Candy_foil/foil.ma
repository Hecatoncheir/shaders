...
//Name: foil.ma
//Last modified: Tue, Sep 01, 2015 01:03:15 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 4.1994101332550313 2.6199343131189234 4.473923280730733 ;
	setAttr ".r" -type "double3" -14.738352729602447 43.800000000000132 0 ;
createNode camera -s -n "perspShape" -p "persp";
	rename -uid "5007E629-F544-E1CC-9A27-0AAFF0F85128";
	setAttr -k off ".v" no;
	setAttr ".fl" 34.999999999999986;
	setAttr ".coi" 6.7057142406695611;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "90C4EFBA-3841-37DC-B6B7-908CA2F2A030";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "A86BC6BE-1C4C-55B8-2FD7-18866C98F032";
createNode displayLayer -n "defaultLayer";
	rename -uid "385B83F7-2A43-1D20-D662-83927D9A2F2D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "4B84B583-6A41-71C7-F8D2-2F93B9C74C2A";

...
//Name: Leather.ma
//Last modified: Thu, Sep 03, 2015 07:17:34 PM
//Codeset: UTF-8
requires maya "2016";
...
createNode transform -s -n "persp";
	...
	setAttr ".v" no;
	setAttr ".t" -type "double3" 0.79257110250820073 1.064127583260253 1.0409044263649243 ;
	setAttr ".r" -type "double3" -26.138352729607323 36.600000000003973 3.9617407190925104e-15 ;
...
createNode camera -s -n "perspShape" -p "persp";
	...
	setAttr -k off ".v" no;
	setAttr ".fl" 30;
	setAttr ".coi" 1.8068430674367124;
...
createNode transform -n "pSphere1";
	rename -uid "EB2C5E63-F841-79F7-063F-0D92D9608C9D";
	setAttr ".t" -type "double3" 0 0.37848788874264516 0 ;
	setAttr ".s" -type "double3" 0.4897881806897208 0.4897881806897208 0.4897881806897208 ;
createNode mesh -n "pSphereShape1" -p "pSphere1";
	rename -uid "3CB02D94-8945-5170-852F-9BAB5FB28097";
	setAttr -k off ".v";
	setAttr ".vir" yes;
	setAttr ".vif" yes;
...
createNode lightLinker -s -n "lightLinker1";
	rename -uid "12C60933-7D43-BC42-21F4-339972761CA2";
	setAttr -s 7 ".lnk";
	setAttr -s 7 ".slnk";
createNode displayLayerManager -n "layerManager";
	rename -uid "C8684CE0-0F4A-0ECF-F24D-0C835C080184";
createNode displayLayer -n "defaultLayer";
	rename -uid "385B83F7-2A43-1D20-D662-83927D9A2F2D";
createNode renderLayerManager -n "renderLayerManager";
	rename -uid "0246B2B2-A246-D24D-BB97-BB8EBC45E582";
...
createNode nodeGraphEditorInfo -n "hyperShadePrimaryNodeEditorSavedTabsInfo";
	rename -uid "80D9A1CB-DE4A-285A-18EA-28AF4B14C65C";
	setAttr ".tgi[0].tn" -type "string" "Untitled_1";
	setAttr ".tgi[0].vl" -type "double2" 278.63576756378819 -736.90473262279886 ;
	setAttr ".tgi[0].vh" -type "double2" 1483.268924329172 377.38093738518131 ;
createNode aiStandard -n "aiStandard1";
	rename -uid "2C700940-444D-E4CC-EE52-B5B253408EBE";
createNode shadingEngine -n "aiStandard1SG";
	rename -uid "C58BDA82-5943-5F20-2329-E3B3BF0B8227";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo2";
	rename -uid "2A72901C-5D45-6903-01C7-E9AAA04085A8";
createNode aiStandard -n "Leather";
	rename -uid "CFBD49BA-8D4D-4B17-3B00-8E9D38731F5D";
	setAttr ".Kd_color" -type "float3" 0.040650409 0.040650409 0.040650409 ;
	setAttr ".diffuse_roughness" 0.54285717010498047;
	setAttr ".Ks" 0.97142857313156128;
	setAttr ".Ks_color" -type "float3" 0.16260162 0.16260162 0.16260162 ;
	setAttr -av ".specular_roughness" 0.32380953431129456;
	setAttr ".Ksss" 0.46666666865348816;
	setAttr ".Ksss_color" -type "float3" 0.056910571 0.056910571 0.056910571 ;
	setAttr ".sss_radius" -type "float3" 0.34959349 0.34959349 0.34959349 ;
createNode shadingEngine -n "Leather_holder";
	rename -uid "9DE9E7E5-5E42-7A7F-D5DC-AF95EA2B1940";
	setAttr ".ihi" 0;
	setAttr ".ro" yes;
createNode materialInfo -n "materialInfo3";
	rename -uid "F68C68C2-4A48-07A0-3226-509DDC15FD84";
createNode file -n "file1";
	rename -uid "B4CEFA13-DD44-E200-7D2B-5F99351CCF8C";
	setAttr ".ail" yes;
	setAttr ".ftn" -type "string" "/Users/Ras/Desktop/shaders/Leather/textures/leather bump.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture1";
	rename -uid "4A85140D-4547-F79A-477F-73A7F0B3B2C5";
	setAttr ".re" -type "float2" 3.0999999 1.1 ;
createNode bump2d -n "bump2d1";
	rename -uid "D0FA850B-AF48-CDBC-EA3B-58A594A92701";
	setAttr ".bd" 0.0099999997764825821;
	setAttr ".vc1" -type "float3" 0 0.00038999988 0 ;
	setAttr ".vc2" -type "float3" 9.9999997e-06 9.9999997e-06 0 ;
createNode file -n "file2";
	rename -uid "AE5B763A-FE49-9D82-E7F7-0FAF1308850C";
	setAttr ".ftn" -type "string" "/Users/Ras/Desktop/shaders/Leather/textures/leather bump.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture2";
	rename -uid "F0DB0DBF-3B47-FFA9-54F9-5AA6433FBFC3";
createNode file -n "file3";
	rename -uid "E0D2EC78-5341-8DC0-1BAF-E6A4B81AADEB";
	setAttr ".ftn" -type "string" "/Users/Ras/Desktop/shaders/Leather/textures/leather bump.png";
	setAttr ".cs" -type "string" "sRGB";
createNode place2dTexture -n "place2dTexture3";
	rename -uid "75D7FF37-5A41-4C2B-C0B1-FDB36D8D46A2";
createNode polySphere -n "polySphere1";
	rename -uid "C35A1774-7240-7AE5-4C5E-02881039949B";
select -ne :time1;
	setAttr ".o" 1;
	setAttr ".unw" 1;
...
relationship "link" ":lightLinker1" "Leather_holder.message" ":defaultLightSet.message";
...
relationship "shadowLink" ":lightLinker1" "Leather_holder.message" ":defaultLightSet.message";
...
connectAttr "candy_foil:scene:pPlaneShape1.iog" "aiStandard1SG.dsm" -na;
connectAttr "aiStandard1SG.msg" "materialInfo2.sg";
connectAttr "aiStandard1.msg" "materialInfo2.m";
connectAttr "aiStandard1.msg" "materialInfo2.t" -na;
connectAttr "bump2d1.o" "Leather.n";
connectAttr "Leather.out" "Leather_holder.ss";
connectAttr "pSphereShape1.iog" "Leather_holder.dsm" -na;
connectAttr "Leather_holder.msg" "materialInfo3.sg";
...
connectAttr "Leather_holder.pa" ":renderPartition.st" -na;
